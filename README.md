...
This project analyzes **UK railway ticket sales and journey performance** to uncover valuable insights related to **passenger behavior, ticket revenue, and train operational efficiency**. The goal is to understand travel demand patterns, evaluate train delays, analyze ticket revenue, and present the results through clear visualizations and an interactive dashboard.
...
1. **Research & Analysis**
   ...
   * Revenue and delay pattern analysis

2. **Visual Identity**
   * Dashboard theme selection
   * Layout organization
   * Clear visual presentation style
...
5. **Review & Finalization**
   ...
   * Validate KPIs and insights
   * Final dashboard adjustments

6. **Final Presentation**
   * Presenting findings
   * Explaining KPIs
   * Demonstrating dashboard insights
...
* **Joseph Milad** – KPI calculation and reporting
* **Yahya Ebrahim** – Passenger behavior and route analysis
* **Ahmed Reda** – Delay analysis and operational insights
* **Ahmed Elsayed** – Dashboard support and presentation preparation
